 ...
 *
 * @ViewsStyle(
 *   id = "custom_serializer_patentes",
 *   title = @Translation("Inversiones Custom serializer patentes"),
 *   help = @Translation("Serializes views row data using the Serializer
 *   component."), display_types = {"data"}
 * )
 */
class CustomSerializerPatentes extends \Drupal\rest\Plugin\views\style\Serializer {
