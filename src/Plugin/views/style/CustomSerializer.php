 ...
 *   title = @Translation("Inversiones Custom serializer"),
 *   help = @Translation("Serializes views row data using the Serializer
 *   component."), display_types = {"data"}
 * )
 */
class CustomSerializer extends \Drupal\rest\Plugin\views\style\Serializer {
  ...
  public function render() {
    ...
    return $this->serializer->serialize($rows[0], $content_type, ['views_style_plugin' => $this]);
